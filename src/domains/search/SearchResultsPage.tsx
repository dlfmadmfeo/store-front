      ...
      <div className="mx-auto max-w-[1280px]">
        ...
        <div className="mt-5 grid gap-5 lg:grid-cols-[minmax(0,1fr)_280px]">
              ...
              <>
                <section className="rounded-[18px] bg-white px-5 py-5 shadow-[0_10px_24px_rgba(15,23,42,0.06)] sm:px-6">
                  <div className="flex items-center justify-between gap-3">
                    <h2 className="text-[20px] font-bold text-[#111827]">전체 {data.totalCount}건</h2>
                ...
                {data.items.map((item) => (
                  <article
                    key={item.id}
                    className="rounded-[18px] bg-white px-5 py-5 shadow-[0_10px_24px_rgba(15,23,42,0.06)] sm:px-6"
                  >
                    <div className="flex flex-col gap-4 sm:flex-row">
                      <div
                        className={`h-[140px] rounded-[16px] bg-gradient-to-br ${item.imageAccent} sm:w-[160px]`}
                        aria-hidden="true"
                      />
                      ...
                      <div className="flex flex-1 flex-col justify-between">
                        <div>
                          ...
                          <h3 className="mt-2 text-[20px] font-semibold text-[#111827]">{item.title}</h3>
                          <p className="mt-2 text-[15px] text-[#6b7280]">{item.seller}</p>
                        </div>

                        <div className="mt-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                          <div>
                            <div className="text-[24px] font-bold text-[#111827]">{item.priceLabel}</div>
                          ...
                          <div className="flex gap-2">
                            <button
                              type="button"
                              className="rounded-[12px] border border-[#d5dbe3] px-4 py-2.5 text-[14px] font-medium text-[#374151]"
                            >
                              장바구니 담기
                            </button>
                            <button
                              type="button"
                              className="rounded-[12px] bg-[#0f172a] px-4 py-2.5 text-[14px] font-semibold text-white"
                            >
                              바로 보기
                            </button>
                          </div>
          ...
          <aside className="space-y-4">
            <section className="rounded-[18px] bg-white px-5 py-5 shadow-[0_10px_24px_rgba(15,23,42,0.06)]">
              <h2 className="text-[18px] font-bold text-[#111827]">연관 검색어</h2>
